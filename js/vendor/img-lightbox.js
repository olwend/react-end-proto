...
(function (root, document) {
	...
	var hideimgLightbox = function () {
		...
		var img = container ? container[getElementsByTagName]("img")[1] || "" : "";
	...
	var imgLightbox = function (scope, settings) {
		...
		var leftNav = "";
		// var arrowLeft = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAcAAAAHCAYAAADEUlfTAAAAJUlEQVR42mNgAILy8vL/DLgASBKnApgkVgXIkhgKiNKJ005s4gDLbCZBiSxfygAAAABJRU5ErkJggg==";
		// var arrowLeft = "img/arrow-left.jpg";
		var rightNav = "";
		// var arrowRight = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAcAAAAHCAYAAADEUlfTAAAAJUlEQVR42mNgAILy8vL/DLgASBKnApgkVgXIkhgKiNKJ005s4gDLbCZBiSxfygAAAABJRU5ErkJggg==";
		// var arrowRight = "img/arrow-right.jpg";
		// var leftImg = container ? container[getElementsByTagName]("img")[0] || "" : "";
		// var rightImg = container ? container[getElementsByTagName]("img")[0] || "" : "";
		...
		if (!container) {
			...
			// leftImg.src = arrowLeft;
			// leftNav[appendChild](leftImg);
			leftNav[classList].add("nav-left");
			rightNav = document[createElement]("div");
			// rightImg = document[createElement]("img");
			// rightImg.src = arrowRight;
			// rightNav[appendChild](rightImg);
				...
				var logicHandleimgLightboxLink = function () {
					...
					if (container && img && hrefString) {
						...
						if (options.onClosed) {
							...
							imgContainer[_addEventListener]("click", handleimgLightboxContainerWithBind);
							...
							imgContainer[_addEventListener]("click", handleimgLightboxContainer);
